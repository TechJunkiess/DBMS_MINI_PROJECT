...
--
-- inserting data for table `drivers_list`
--

INSERT INTO `drivers_list` (`id`, `license_id_no`, `name`, `status`, `date_created`, `date_updated`) VALUES
(1, 'IS037', 'Rakshitha', 1, '2021-08-19 10:45:48', '2021-08-19 10:53:02'),
...
CREATE PROCEDURE delete_driver_sp(IN driver_id INT)
BEGIN
    DELETE FROM drivers_list WHERE id = driver_id;
END
